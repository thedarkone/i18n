...
@LazyReloading@ extension tries to mitigate the issue by first checking @mtime@s of the translation files before reloading them. It is also helpful even if you are only using @Simple@ backend and have a big application with huge translation files.
